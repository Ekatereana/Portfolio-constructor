       ...
       <ul className="navbar-nav mr-auto">
         {this.props.isAuthorized.home ? (
           <li className="nav-item active">
             <a className="nav-link" href="/preview/#">Home<span className="sr-only">(current)</span></a>
           </li>
         ) : null}

         {this.props.isAuthorized.aboutMe ? (
           <li className="nav-item">
             <a className="nav-link" href="/preview/#about">About Me</a>
           </li>
         ) : null}

         {this.props.isAuthorized.portfolio ? (
           <li className="nav-item">
             <a className="nav-link" href="/preview/#portfolio">Portfolio</a>
           </li>
         ) : null}

         {this.props.isAuthorized.services ? (
           <li className="nav-item">
             <a className="nav-link" href="/preview/#services">Services</a>
           </li>
         ) : null}
